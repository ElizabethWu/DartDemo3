 ...
 */
class Privileges {
    CONST TOGGLE_INFO_VIEW = 'A2';                      //A2  10
    CONST TOGGLE_INFO_EDIT = 'A4';                      //A3  100
    CONST STUDENT_BASIC_INFO_VIEW = 'A8';               //A4  1000
    CONST STUDENT_BASIC_INFO_EDIT = 'A16';              //A5  10000
    CONST STUDENT_INFO_EDIT = 'A32';                    //A6  100000
    CONST SFA_VIEW = 'A64';                             //A7  1000000
    ...
    //add features by Elizabeth Wu
    
    CONST VIEW_DEWIS_STUDENT='B16384';                  //B15
    CONST EDIT_DEWIS_STUDENT='B32768';                     //B16
    CONST DEWIS_ADMIN='B65536';                            //B17
    const EDIT_PATHWAY='B131072';                             //b18
    CONST SET_PATHWAY='B2';                                //B2
    CONST VIEW_DISCIP_IND='B524288';                       //B20
    CONST EDIT_DISCIP_IND='B1048576';                       //b21
    CONST VIEW_DISCIP_ADMIN='B2097152';                     //B22
    CONST EDIT_DISCIP_ADMIN='B4194304';                     //b23
    CONST VIEW_DISCIP_SPED='B8388608';                      //b24
    CONST EDIT_DISCIP_SPED='B16777216';                      //B25
    CONST VIEW_DISCIP_ALL='B33554432';                      //B26
    const ACT_EDIT='B67108864';                             //B27
    const edit_sped='B134217728';                           //B28
    const delte_discipline='B268435456';                    //B29
//
    //end
