...
//after create a session for this user, all his/her info has been retrived from DB. 
...
//import all the library that'll be used for this module
...
//if the operation is cmd, $cmd is the thing after the equal sign
if (isset($_GET['cmd']))
    $cmd = $_GET['cmd'];
else
    $cmd="";
...
//if the command is "module", the $cmd is " module". and the $module is the exact module
...
switch ($cmd) {
    case "gpaEdit":
		...
		break;
     case "editTable":
		include("editTable.inc");
		break;
     case "editStandards":
		include("editStandards.inc");
		break;
     case "groupEdit":
		include("groupEdit.inc");
		break;  
      case "groupMovement":
		include("groupmovement.inc");
		break;
   case "groupCourse":
		include("groupcourse.inc");
		break;
   case "groupEdit":
		include("groupedit.inc");
		break;
   case "groupAdd":
		include("groupadd.inc");
		break;
   case "groupClose":
		include("groupclose.inc");
		break;
            
     case "internalsystem":
		include("internalsystem.inc");
		break;
    case "gradTesting":
		include("gradTesting.inc");
		break;
   case "gradSaving":
		include("gradSaving.inc");
		break;
            
     case "pathwayEdit":
		include("pathwayEdit.inc");
		break;
   case "pathwayEditElectives":
		include("pathwayEditElectives.inc");
		break;
   case "pathwayEditSave":
		include("pathwayEditSave.inc");
		break;
   case "pathwayComments":
		include("pathwayComments.inc");
		break;
   case "pathwayCommentSave":
		include("pathwayCommentSave.inc");
		break;
    ...
    case "updateStudentLevel":
        ...
        break;
    case "disciplineAll":
		include("disciplineAll.inc");
		break;
    case "disciplineList":
        include("disciplineList.inc");
        break;
    case "disciplineListNew":
        include("disciplineListNew.inc");
        break;
    case "disciplineEdit":
        include("disciplineEdit.inc");
        break;
    case "disciplineEditNew":
		include("disciplineEditNew.inc");
		break;
...
//			echo "{$r['studentid']}-{$r['subject']}-{$r['level']};";
    ...
    case "saveDB":
        include("saveDB.inc");
        break;
    //new feature added by Elizabeth Wu
    
    case "dewisList":
		include("dewisList.inc");
		break;
   case "dewisItem":
		include("dewisItem.inc");
		break;
   case "dewisNotesEdit":
		include("dewisNotesEdit.inc");
		break;
   case "dewisTestEdit":
		include("dewisTestEdit.inc");
		break;
   case "dewisStudentEdit":
		include("dewisStudentEdit.inc");
		break;
   case "dewisImportTest":
		include("dewisImportTest.inc");
		break;
   case "dewisEndReason":
		include("dewisEndReason.inc");
		break;
   //end of apending
