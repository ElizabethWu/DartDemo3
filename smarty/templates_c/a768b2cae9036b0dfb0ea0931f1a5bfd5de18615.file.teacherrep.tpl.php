<?php /* Smarty version Smarty-3.0.8, created on 2012-07-07 20:00:07
         compiled from "/home/dartdem2/public_html/lib/../smarty/templates/teacherrep.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8216373454ff905c75a5609-26456858%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a768b2cae9036b0dfb0ea0931f1a5bfd5de18615' => 
    array (
      0 => '/home/dartdem2/public_html/lib/../smarty/templates/teacherrep.tpl',
      1 => 1341264879,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8216373454ff905c75a5609-26456858',
  'function' => 
  array (
  ),
...
favicon.ico" />
        ...
        <title>DSD DART: Teacher SIP Report</title>
...
<form action=index.php method=get>
    ...
    <select name="site" id="site" onChange="submit()">
        <option value=''>-select-</option>
            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->getVariable('sitelist')->value,'selected'=>$_smarty_tpl->getVariable('selectedSite')->value),$_smarty_tpl);?>

    </select>
</form>
<br/><br/>

    <?php  $_smarty_tpl->tpl_vars['teacherActionPlan'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('teacherActionPlans')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['teacherActionPlan']->key => $_smarty_tpl->tpl_vars['teacherActionPlan']->value){
?>
<strong><?php echo $_smarty_tpl->tpl_vars['teacherActionPlan']->value['teacher'];?>
</strong><br>
<table cellpadding="5px" cellspacing="0px" border=1>
 ...
 $_from = $_smarty_tpl->tpl_vars['teacherActionPlan']->value['actionPlans']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['actionPlan']->key => $_smarty_tpl->tpl_vars['actionPlan']->value){
?>
    <tr>
        <td width=50%<?php ?>><?php echo $_smarty_tpl->tpl_vars['actionPlan']->value['action'];?>
</td>
