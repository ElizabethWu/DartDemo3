<?php /* Smarty version Smarty-3.0.8, created on 2012-07-03 14:57:13
         compiled from "/home/dartdem2/public_html/lib/../smarty/templates/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3955902134ff378c9571288-07835299%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b18d510abce0930067e559f49e748bfa48bee25e' => 
    array (
      0 => '/home/dartdem2/public_html/lib/../smarty/templates/history.tpl',
      1 => 1341264879,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3955902134ff378c9571288-07835299',
  'function' => 
  array (
  ),
...
<div style="width:1024px; margin: auto; padding-bottom:30px;">
	Entire History<br />
	<a href=index.php?cmd=history<?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable;
...
' />
		...
		Toggle Type:
		<?php echo smarty_function_html_options(array('name'=>"toggle",'options'=>$_smarty_tpl->getVariable('typeMenu')->value,'selected'=>$_smarty_tpl->getVariable('searchParameters')->value['toggle']),$_smarty_tpl);?>
		...
		<?php echo smarty_function_html_options(array('name'=>"subject",'options'=>$_smarty_tpl->getVariable('subjectMenu')->value,'selected'=>$_smarty_tpl->getVariable('searchParameters')->value['subject']),$_smarty_tpl);?>

		<?php echo smarty_function_html_options(array('name'=>"level",'options'=>$_smarty_tpl->getVariable('levelMenu')->value,'selected'=>$_smarty_tpl->getVariable('searchParameters')->value['level']),$_smarty_tpl);?>
...
?>
		<tr>
			<td><?php echo $_smarty_tpl->tpl_vars['h']->value['dt'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['h']->value['type'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['h']->value['user'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['h']->value['subject'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['h']->value['lvl'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['h']->value['std'];?>
</td>
...
$_template->properties['nocache_hash']  = '3955902134ff378c9571288-07835299';
