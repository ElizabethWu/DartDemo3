<?php /* Smarty version Smarty-3.0.8, created on 2012-07-05 20:44:40
         compiled from "/home/dartdem2/public_html/lib/../smarty/templates/siterep.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21172423524e0daa8abd4631-48673141%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c75a164b80222bff76f7f9ffe719facde690894' => 
    array (
      0 => '/home/dartdem2/public_html/lib/../smarty/templates/siterep.tpl',
      1 => 1309202352,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '21172423524e0daa8abd4631-48673141',
  'function' => 
  array (
  ),
...
favicon.ico" />
        ...
        <title>DSD DART: Site Improvement Plan</title>
...
?>
        <option value ="<?php echo $_smarty_tpl->tpl_vars['site']->value['siteid'];?>
"
                <?php if (($_smarty_tpl->tpl_vars['site']->value['siteid']==$_smarty_tpl->getVariable('selectedSiteId')->value)){?>
                selected
                <?php }?>>
...
<?php if ($_smarty_tpl->getVariable('report')->value){?>
        ...
        <td width="60%">
            <div align="left">
                ...
                <font color="#cc0000" size="4"
                    ...
                    Site Improvement Plan: <?php echo (($_smarty_tpl->getVariable('report')->value->year).("-")).((substr(($_smarty_tpl->getVariable('report')->value->year+1),2,2)));?>
 School Year
                </font>
            </div>
            <blockquote>
    ...
    <tr>
        <td>
            <?php echo $_smarty_tpl->getVariable('report')->value->intro;?>
    ...
    <table width="750" border="1" cellspacing="2" cellpadding="0">
        ...
        <tr>
            <td>
                <div align="left">
                    <font size="2" face="Arial">
                                    <?php echo $_smarty_tpl->getVariable('report')->value->stateQ2Reponse->response;?>
