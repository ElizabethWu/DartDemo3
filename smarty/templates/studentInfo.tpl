                        ...
                        <tr>
                            <td colspan="3"><br>
                                ...
                                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                    <tr>
                                        <td nowrap bgcolor="#ccccff" width="15%"><font size="2"><b
                                                <a href="javascript:editValue('HSGQE_Reading:','HSGQEReading','{$student.HSGQEReading}');">Exit Exam Reading: </a>
                                            </b></font></td>
                                    ...
                                    <tr>
                                        <td nowrap bgcolor="#ccccff" width="15%"><font size="2"><b>
                                                <a href="javascript:editValue('HSGQE_Writing:','HSGQEWriting','{$student.HSGQEWriting}');">Exit Exam Writing: </a>
                                            </b></font></td>
                                    ...
                                    <tr>
                                        <td nowrap bgcolor="#ccccff" width="15%"><font size="2"><b>
                                                <a href="javascript:editValue('HSGQE_Math:','HSGQEMath','{$student.HSGQEMath}');">Exit Exam Math: </a>
                                            </b></font></td>
