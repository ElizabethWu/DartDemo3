                                        ...
                                        <tr class="listhead">
                                            ...
                                            {/if}
                                             <td align="center" nowrap>
                                                <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.lname&dir={$dir}&start={$start}&end={$end}&total={$total}">&nbsp;Name&nbsp;</a></td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.studentid&dir={$dir}&start={$start}&end={$end}&total={$total}">Student Number</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.alaskaid&dir={$dir}&start={$start}&end={$end}&total={$total}">AK Student ID</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.site &dir={$dir}&start={$start}&end={$end}&total={$total}">School Site</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.fname&dir={$dir}&start={$start}&end={$end}&total={$total}">Time Frame</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.grade&dir={$dir}&start={$start}&end={$end}&total={$total}">Testing Grade</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=bday&dir={$dir}&start={$start}&end={$end}&total={$total}">Age</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.status &dir={$dir}&start={$start}&end={$end}&total={$total}">Status&nbsp;</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.sped&dir={$dir}&start={$start}&end={$end}&total={$total}">SpEd Status&nbsp;</a></div>
                                            </td>
                                            <td align="center">
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort=student.gpa &dir={$dir}&start={$start}&end={$end}&total={$total}">GPA&nbsp;</a></div>
                                            </td>
                                            
                                            <td align="center" nowrap>
                                                <div align="center">
                                                    <a href="index.php?cmd=searchResults&sql={$currentSearch}&sort={$sort}&dir={$dir}&start={$start}&end={$end}&total={$total}">&nbsp;Action&nbsp;</a>
                                                </div>
                                            </td>
						...
						{$student.GPA}
                                            ...
                                            <td align="center" nowrap>
                                                <div align="center">
                                                    ...
                                                    <a href="index.php?cmd=StudentEdit&id={$student.studentid}" > Edit >> </a>
